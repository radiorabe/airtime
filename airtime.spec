#
# spec file for airtime packages
#
...
# https://github.com/radiorabe/airtime
#
...
install contrib/systemd/*.service %{buildroot}/%{_unitdir}
install contrib/systemd/*.timer %{buildroot}/%{_unitdir}
