var AIRTIME = (function(AIRTIME){
    ...
    mod.refresh = function(schedId) {
        ...
        if (schedId > 0) {
            $.post(baseUrl+"calendar/update-future-is-scheduled",
    ...
    mod.fnItemCallback = function(json) {
        ...
        mod.enableUI();
        //Unneccessary reload of the library pane after moving tracks in the now-playing pane.
        //$("#library_content").find("#library_display").dataTable().fnStandingRedraw();
    };
    ...
    mod.builderDataTable = function() {
        ...
        oSchedTable = $sbTable.dataTable( {
            ...
            "sAjaxSource": baseUrl+"now-playing/builder-feed"
        });
        ...
        $.contextMenu({
            ...
            build: function($el, e) {
                ...
                request = $.ajax({
                  url: baseUrl+"now-playing/context-menu",
                  type: "GET",
