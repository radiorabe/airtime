var AIRTIME = (function(AIRTIME) {
    ...
    function aggregateHistoryTable() {
        ...
        fnRowCallback = function( nRow, aData, iDisplayIndex, iDisplayIndexFull ) {
        	var editUrl = baseUrl+"playout-history/edit-file-item/id/"+aData.file_id,
        		$nRow = $(nRow);
        ...
        oTable = $historyTableDiv.dataTable( {
            ...
            "bProcessing": true,
            "bServerSide": true,
            "sAjaxSource": baseUrl+"playout-history/file-history-feed",
    ...
    function itemHistoryTable(id) {
        ...
        fnRowCallback = function( nRow, aData, iDisplayIndex, iDisplayIndexFull ) {
        	var editUrl = baseUrl+"playout-history/edit-list-item/id/"+aData.history_id,
        		deleteUrl = baseUrl+"playout-history/delete-list-item/id/"+aData.history_id,
        ...
        oTable = $historyTableDiv.dataTable( {
            ...
            "bProcessing": true,
            "bServerSide": true,
            "sAjaxSource": baseUrl+"playout-history/item-history-feed",
            "sAjaxDataProp": "history",
            "fnServerData": fnServerData,
            "fnRowCallback": fnRowCallback,
            "oLanguage": datatables_dict,
    ...
    function showSummaryList(start, end) {
    	var url = baseUrl+"playout-history/show-history-feed",
    		data = {
    			format: "json",
	    		start: start,
	    	    end: end
    ...
    mod.onReady = function() {
    	...
    	$historyContentDiv.on("click", "#his_create", function(e) {
    		var url = baseUrl+"playout-history/edit-list-item/format/json"	;
    	...
    	$('body').on("click", "#his_instance_retrieve", function(e) {
    		var startPicker = $hisDialogEl.find('#his_item_starts'),
				...
				url = baseUrl+"playout-history/show-history-feed",
    	...
    	$historyContentDiv.on("click", "#his_trash", function(ev){
    		var items = getSelectedLogItems(),
    			url = baseUrl+"playout-history/delete-list-items";
