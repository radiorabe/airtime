...
function viewDisplay( view ) {
    ...
    if(view.name === 'agendaDay' || view.name === 'agendaWeek') {
        ...
        var select = $('<select class="schedule_change_slots input_select"/>')
            ...
            .change(function(){
                ...
                var url = baseUrl+'calendar/set-time-interval/format/json';
    ...
    var url = baseUrl+'calendar/set-time-scale/format/json';
...
function eventDrop(event, dayDelta, minuteDelta, allDay, revertFunc, jsEvent, ui, view) {
    var url = baseUrl+'calendar/move-show/format/json';
...
function eventResize( event, dayDelta, minuteDelta, revertFunc, jsEvent, ui, view ) {
    var url = baseUrl+'calendar/resize-show/format/json';
...
function getFullCalendarEvents(start, end, callback) {
    ...
    if (initialLoad) {
        ...
        url = baseUrl+'calendar/event-feed';
...
function getCurrentShow() {
    ...
    var url = baseUrl+'calendar/get-current-show/format/json';
