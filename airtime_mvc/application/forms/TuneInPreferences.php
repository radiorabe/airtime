...
class Application_Form_TuneInPreferences extends Zend_Form_SubForm
{
    public function init()
    {
        ...
        $enableTunein->setValue(Application_Model_Preferences::getTuneinEnabled());
        ...
        $tuneinStationId->setValue(Application_Model_Preferences::getTuneinStationId());
        ...
        $tuneinPartnerKey->setValue(Application_Model_Preferences::getTuneinPartnerKey());
        ...
        $tuneinPartnerId->setValue(Application_Model_Preferences::getTuneinPartnerId());
