...
class AudioPreviewController extends Zend_Controller_Action
{
    ...
    public function audioPreviewAction()
    {
        ...
        $this->view->headScript()->appendFile(
            $baseUrl.'js/airtime/audio-preview/preview_jplayer.js?'.$CC_CONFIG['airtime_version'],
            'text/javascript');
        $this->view->headScript()->appendFile(
    ...
    public function playlistPreviewAction()
    {
        ...
        $this->view->headScript()->appendFile($baseUrl.'js/airtime/audio-preview/preview_jplayer.js?'.$CC_CONFIG['airtime_version'],'text/javascript');
