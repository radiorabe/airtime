...
class NowPlayingController extends Zend_Controller_Action
{
    ...
    public function indexAction()
    {
        ...
        $form = new Application_Form_NowPlaying();
        $form->populate(array(
        ...
        $this->view->headScript()->appendFile($baseUrl.'js/airtime/now-playing/main_builder.js?'.$CC_CONFIG['airtime_version'],'text/javascript');
    ...
    public function builderDialogAction()
    {
        ...
        $this->view->dialog = $this->view->render('now-playing/builderDialog.phtml');
    }
