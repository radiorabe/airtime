...
class PlayoutHistoryController extends Zend_Controller_Action
{
    ...
    public function indexAction()
    {
        ...
        $this->view->headScript()->appendFile($baseUrl.'js/airtime/playout-history/historytable.js?'.$CC_CONFIG['airtime_version'],'text/javascript');
        ...
        $this->view->headLink()->appendStylesheet($baseUrl.'css/playout-history.css?'.$CC_CONFIG['airtime_version']);
    ...
    public function editFileItemAction()
    {
    	...
    	$this->view->form = $form;
    	$this->view->dialog = $this->view->render('playout-history/dialog.phtml');
    ...
    public function createListItemAction()
    {
    	try {
	        ...
	        if (isset($json["form"])) {
	        	...
	        	$json["form"] = $this->view->render('playout-history/dialog.phtml');
