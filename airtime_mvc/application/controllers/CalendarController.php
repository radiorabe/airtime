...
class CalendarController extends Zend_Controller_Action
{
    ...
    public function init()
    {
        ...
        $this->sched_sess = new Zend_Session_Namespace("calendar");
    }
    ...
    public function indexAction()
    {
        ...
        //Embed the calendar in our page response so we don't have to make an AJAX request to get this data after the page load.
        $scheduleController = new CalendarController($this->getRequest(), $this->getResponse());
        ...
        $this->view->headScript()->offsetSetFile(90, $baseUrl.'js/airtime/calendar/full-calendar-functions.js?'.$CC_CONFIG['airtime_version'],'text/javascript');
        ...
        $this->view->headScript()->appendFile($baseUrl.'js/airtime/calendar/add-show.js?'.$CC_CONFIG['airtime_version'],'text/javascript');
        $this->view->headScript()->offsetSetFile(100, $baseUrl.'js/airtime/calendar/calendar.js?'.$CC_CONFIG['airtime_version'],'text/javascript');
        ...
        $this->view->headScript()->appendFile($baseUrl.'js/airtime/now-playing/builder.js?'.$CC_CONFIG['airtime_version'],'text/javascript');

        $this->view->headLink()->appendStylesheet($baseUrl.'css/media_library.css?'.$CC_CONFIG['airtime_version']);
        $this->view->headLink()->appendStylesheet($baseUrl.'css/jquery.contextMenu.css?'.$CC_CONFIG['airtime_version']);
        $this->view->headLink()->appendStylesheet($baseUrl.'css/datatables/css/ColVis.css?'.$CC_CONFIG['airtime_version']);
        $this->view->headLink()->appendStylesheet($baseUrl.'css/datatables/css/ColReorder.css?'.$CC_CONFIG['airtime_version']);
        $this->view->headLink()->appendStylesheet($baseUrl.'css/now-playing.css?'.$CC_CONFIG['airtime_version']);
    ...
    public function moveShowAction()
    {
        ...
        $log_vars["action"] = "calendar/move-show";
    ...
    public function resizeShowAction()
    {
        ...
        $log_vars = array();
        $log_vars["url"] = $_SERVER['HTTP_HOST'];
        $log_vars["action"] = "calendar/resize-show";
        $log_vars["params"] = array();
    ...
    public function deleteShowInstanceAction()
    {
        ...
        $log_vars = array();
        $log_vars["url"] = $_SERVER['HTTP_HOST'];
        $log_vars["action"] = "calendar/delete-show-instance";
        $log_vars["params"] = array();
        $log_vars["params"]["instance id"] = $instanceId;
        Logging::info($log_vars);
    ...
    public function clearShowAction()
    {
        ...
        $log_vars = array();
        $log_vars["url"] = $_SERVER['HTTP_HOST'];
        $log_vars["action"] = "calendar/clear-show";
        $log_vars["params"] = array();
        $log_vars["params"]["instance id"] = $instanceId;
        Logging::info($log_vars);
    ...
    public static function printCurrentPlaylistForEmbedding()
    {
        ...
        $scheduleController = new CalendarController($front->getRequest(), $front->getResponse());
    ...
    public function showContentDialogAction()
    {
        ...
        $this->view->dialog = $this->view->render('calendar/show-content-dialog.phtml');
    ...
    public function populateRepeatingShowInstanceFormAction()
    {
        ...
        $this->view->newForm = $this->view->render('calendar/add-show-form.phtml');
    }
    ...
    public function getFormAction()
    {
        ...
        if ($currentUser->isAdminOrPM()) {
            $this->createShowFormAction(true);
            $this->view->addNewShow = true;
            $this->view->form = $this->view->render('calendar/add-show-form.phtml');
        }
    }
    ...
    public function editRepeatingShowInstanceAction(){
        ...
        $log_vars = array();
        $log_vars["url"] = $_SERVER['HTTP_HOST'];
        $log_vars["action"] = "calendar/edit-repeating-show-instance";
        $log_vars["params"] = array();
    ...
    public function editShowAction()
    {
        ...
        $log_vars = array();
        $log_vars["url"] = $_SERVER['HTTP_HOST'];
        $log_vars["action"] = "calendar/edit-show";
        $log_vars["params"] = array();
        $log_vars["params"]["form_data"] = $data;
        Logging::info($log_vars);
    ...
    public function addShowAction()
    {
        ...
        $log_vars = array();
        $log_vars["url"] = $_SERVER['HTTP_HOST'];
        $log_vars["action"] = "calendar/add-show";
        $log_vars["params"] = array();
        $log_vars["params"]["form_data"] = $data;
        Logging::info($log_vars);
    ...
    public function deleteShowAction()
    {
        ...
        $log_vars = array();
        $log_vars["url"] = $_SERVER['HTTP_HOST'];
        $log_vars["action"] = "calendar/delete-show";
        $log_vars["params"] = array();
        $log_vars["params"]["instance id"] = $instanceId;
        Logging::info($log_vars);
    ...
    public function cancelCurrentShowAction()
    {
        $log_vars = array();
        $log_vars["url"] = $_SERVER['HTTP_HOST'];
        $log_vars["action"] = "calendar/cancel-current-show";
        $log_vars["params"] = array();
    ...
    /**
     * Sets the user specific preferences for which time scale to use in Calendar.
     * This is only being used by calendar.js at the moment.
     */
	...
	/**
     * Sets the user specific preferences for which time interval to use in Calendar.
     * This is only being used by calendar.js at the moment.
     */
