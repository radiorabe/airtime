...
class ListenerStatsController extends Zend_Controller_Action
{
    ...
    public function indexAction()
    {
        ...
        $this->view->headScript()->appendFile($baseUrl.'js/airtime/listener-stats/listener-stats.js?'.$CC_CONFIG['airtime_version'],'text/javascript');
        ...
        $errorStatus = Application_Model_Streams::GetAllListenerStatErrors();
