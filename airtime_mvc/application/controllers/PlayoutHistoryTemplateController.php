...
class PlayoutHistoryTemplateController extends Zend_Controller_Action
{
	...
	public function indexAction()
	{
		...
		$this->view->headScript()->appendFile($baseUrl.'js/airtime/playout-history/template.js?'.$CC_CONFIG['airtime_version'],'text/javascript');
	...
	public function configureTemplateAction() {
		...
		$this->view->headScript()->appendFile($baseUrl.'js/airtime/playout-history/configuretemplate.js?'.$CC_CONFIG['airtime_version'],'text/javascript');
		$this->view->headLink()->appendStylesheet($baseUrl.'css/history_styles.css?'.$CC_CONFIG['airtime_version']);
		...
		try {
			...
			$this->_forward('index', 'playout-history-template');
		}
	}
