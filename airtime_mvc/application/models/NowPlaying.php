...
class Application_Model_NowPlaying
{
    ...
    private function makeHeaderRow($p_item)
    {
        ...
        if (intval($p_item["si_rebroadcast"]) === 1) {
            ...
            if (Application_Model_Preferences::GetUploadToSoundcloudOption() && isset($p_item['si_file_id'])) {
     ...
     *
     * @return boolean whether the calendar in the show builder's range has
     * been updated.
     *
     */
