...
SQL;
    ...
    /**
     * Gets stream of old shows by metadata. Added by bzf.
     *
     * @param $shows The number of shows to return.
     * @return An array containing show metadata.
     *	
     */
    public static function getPlayoutMetadata($showsToRetrieve)
    {
	...
	if (isset($showsToRetrieve)) {
	
		if ($showsToRetrieve < 101) {
		
			$numberOfShowsToGet = $showsToRetrieve;
		
		} else {
		
			// $finalResult = "ERROR: You can't get more than 100 shows.";
			$finalResult = "ERROR: " . $showsToRetrieve;
